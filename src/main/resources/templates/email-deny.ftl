                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">Registration</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <p><br/><br/></p>
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;"></span><br/><br/><span
                                                style="font-weight: 400;">Your request for trial access was not approved. Please contact support@rfpintels.com in case of any further questions.</span>
