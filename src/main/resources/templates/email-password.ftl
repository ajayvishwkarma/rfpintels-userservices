                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">User Added Successfully</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <p><br/><br/></p>
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">You have been added as a user on <strong>RFPIntels Portal</strong>. Kindly use below credentials to login to the application.</span><br/><br/>
