                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Thank you for joining <strong>RFPIntels Application</strong> !!!</span><br/><br/><span
                                                style="font-weight: 400;">Your request for trial access is now approved. Please login using the same credentials that you created during the registration.</span>
                                                            ...
                                                            <tr>
                                                                <td class="button__td "
                                                                    ...
                                                                    <![endif]--> <!-- [if !mso]><!--> <a
                                                                            ...
                                                                            href="${userEmailLoginLink}"
                                                                            target="_blank"
                                                                            rel="noopener">Login Here
                                                                						</a> <!--![endif]--></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Our best, <br/> The RFPIntels Application team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
